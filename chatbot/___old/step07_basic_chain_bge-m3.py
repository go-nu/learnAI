"""
=======================================================
[STEP 07] LCEL 기본 체인 — 파이프(|)로 컴포넌트 연결하기 (BGE-M3)
=======================================================
...
■ 실행 방법
  python step07_basic_chain_bge-m3.py
  ※ chroma_db_bge_m3가 있으면 재사용, 없으면 source/manual.pdf에서 생성합니다.
  ※ 임베딩: BAAI/bge-m3 (로컬, API 키 불필요) / LLM: Gemini (API 키 필요)
=======================================================
"""
