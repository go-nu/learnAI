...
# 설정값
# ══════════════════════════════════════════════════════════════════════
PDF_PATH    = "./source/fault_ratio_standards_2023_ex213.pdf"   # 사용할 PDF 경로
CHROMA_DIR  = "./chroma_db_bge_m3_test"  # ChromaDB 저장 디렉토리
...
if __name__ == "__main__":
    ...
    test_queries = [
        # 텍스트 검색
        ("인적 손해에서의 과실상계 별도적용기준 유형에 대해 알려주세요",           None),
        # 표 검색
        ("인적 손해에서의 과실상계 별도적용기준 유형에 대해 알려주세요",   "table"),
    ]
